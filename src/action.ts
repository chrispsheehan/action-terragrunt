...
export const parentRepoOrigin = 'https://github.com/gruntwork-io/terragrunt';
const downloadUrlFormat = `${parentRepoOrigin}/releases/download/%s/${fullExecutableFormat}`;
